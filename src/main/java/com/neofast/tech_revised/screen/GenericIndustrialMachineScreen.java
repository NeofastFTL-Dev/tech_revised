...
public class GenericIndustrialMachineScreen extends AbstractContainerScreen<GenericIndustrialMachineMenu> {
    ...
    public GenericIndustrialMachineScreen(GenericIndustrialMachineMenu menu, Inventory playerInventory, Component title) {
