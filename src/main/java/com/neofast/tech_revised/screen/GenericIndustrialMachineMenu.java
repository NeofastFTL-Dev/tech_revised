...
import com.neofast.tech_revised.block.entity.custom.GenericIndustrialMachineBlockEntity;
...
public class GenericIndustrialMachineMenu extends AbstractContainerMenu {
    ...
    private final GenericIndustrialMachineBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;
    private final int[] syncedData = new int[4];

    public GenericIndustrialMachineMenu(int containerId, Inventory inventory, FriendlyByteBuf extraData) {
        this(containerId, inventory, inventory.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public GenericIndustrialMachineMenu(int containerId, Inventory inventory, BlockEntity entity) {
        super(ModMenuTypes.GENERIC_INDUSTRIAL_MACHINE_MENU.get(), containerId);
        this.blockEntity = (GenericIndustrialMachineBlockEntity) entity;
